...
# get the API_KEY for yelp from the constants api_key file
YELP_API_KEY = constants.YELP_API_KEY
YELP_API_CLIENT_ID = constants.YELP_API_CLIENT_ID
YELP_API_HOST = constants.YELP_API_HOST # 'https://api.yelp.com'

YELP_BUSINESS_SEARCH_PATH = '/v3/businesses/search'
...
def search(api_key, term, location):
    ...
    return request(YELP_API_HOST, YELP_BUSINESS_SEARCH_PATH, api_key, url_params=url_params)
...
def main():
    ...
    parser.add_argument('-q', '--term', dest='term', default=YELP_DEFAULT_TERM,
                        type=str, help='Search term (default: %(default)s)')
    parser.add_argument('-l', '--location', dest='location',
                        default=YELP_DEFAULT_LOCATION, type=str,
